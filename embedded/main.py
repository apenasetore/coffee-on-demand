...
if __name__ == "__main__":
    ...
    multiprocessing.Process(target=generate_response, daemon=True, args=(customer_queue, audio_queue, capture_audio_event_flag, recognize_customer_event_flag)).start()
